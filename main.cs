...
class MainClass {
  public static void Main (string[] args) {
    ...
    Faculty f1 = new Faculty("Sarah", "Greywitt");    
    f1.DateOfBirth = Convert.ToDateTime("01/01/1975");
    f1.PermanentAddress.AddressLine1 = "1811 West 52nd Street";
    f1.PermanentAddress.City = "Cleveland";
    f1.PermanentAddress.State = "OH";
    f1.PermanentAddress.Zipcode = "44102";
    f1.DateOfEmployment=Convert.ToDateTime("07/21/2019");
    f1.Employer = "Ohio State University";
    f1.Intro();
    f1.Title = "Instructor";
    f1.GrantTenure();
    f1.Promote();
